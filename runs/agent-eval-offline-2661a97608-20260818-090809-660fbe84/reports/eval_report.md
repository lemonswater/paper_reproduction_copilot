...
- Eval ID：`agent-eval-offline-2661a97608`
- Suite：`offline`
- Passed：`True`
...
- Score：`1.0000`
- Runner：`paper_parser`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-offline-2661a97608-20260818-090809-660fbe84/traces/eval_cases/offline_maple_paper_parser/observation.json`
...
- Score：`1.0000`
- Runner：`fixture`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-offline-2661a97608-20260818-090809-660fbe84/traces/eval_cases/mapping_quality_maple/observation.json`
...
- Score：`1.0000`
- Runner：`fixture`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-offline-2661a97608-20260818-090809-660fbe84/traces/eval_cases/mapping_quality_p4transformer/observation.json`
...
- Score：`1.0000`
- Runner：`fixture`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-offline-2661a97608-20260818-090809-660fbe84/traces/eval_cases/mapping_quality_psttransformer/observation.json`
...
- Score：`1.0000`
- Runner：`paper_parser`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-offline-2661a97608-20260818-090809-660fbe84/traces/eval_cases/offline_p4transformer_paper_parser/observation.json`
...
- Score：`1.0000`
- Runner：`paper_parser`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-offline-2661a97608-20260818-090809-660fbe84/traces/eval_cases/offline_psttransformer_paper_parser/observation.json`
...
- `PASS` `QUALITY_PAPER_PARENT:3.3`：子章节必须绑定到显式父编号
  - expected：`{"child_number": "3.3", "parent_number": "3"}`
  - actual：`[{"number": "3.3", "title": "Architectures", "parent_number": "3", "parent_title": "POINT SPATIO-TEMPORAL TRANSFORMER"}]`
