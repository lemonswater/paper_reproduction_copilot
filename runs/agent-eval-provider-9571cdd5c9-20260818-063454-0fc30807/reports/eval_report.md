...
- Eval ID：`agent-eval-provider-9571cdd5c9`
- Suite：`provider`
- Passed：`False`
...
- Score：`0.3333`
- Runner：`live_graph`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-provider-9571cdd5c9-20260818-063454-0fc30807/traces/eval_cases/provider_pstnet_mapping/observation.json`
...
- Score：`0.4062`
- Runner：`live_graph`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-provider-9571cdd5c9-20260818-063454-0fc30807/traces/eval_cases/provider_pstnet_section_understanding/observation.json`
...
- Score：`0.3333`
- Runner：`live_graph`
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-provider-9571cdd5c9-20260818-063454-0fc30807/traces/eval_cases/provider_p4transformer_mapping/observation.json`
...
- Observation：`/data/tianshaoqi24/agent/paper_reproduction_copilot/runs/agent-eval-provider-9571cdd5c9-20260818-063454-0fc30807/traces/eval_cases/provider_retrieval_obfuscated_semantics/observation.json`
